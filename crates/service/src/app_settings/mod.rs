...
pub use gateway::{
    ...
    current_gateway_mode, current_gateway_originator, current_gateway_request_compression_enabled,
    ...
    gateway_mode_options, residency_requirement_options, set_gateway_account_max_inflight,
    set_gateway_background_tasks, set_gateway_free_account_max_model, set_gateway_mode,
